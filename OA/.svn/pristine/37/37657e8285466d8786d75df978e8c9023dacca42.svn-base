	...
	$('#pifu').click(function() {// 换肤界面
				...
				$.ajax({// 获取用户相关所有信息包括是否登录判断
					...
					success : function(msg) {
						...
						var imgs = $('<img/>');
						/*	imgs.attr("src", '/OA/user_testpic?backurls='
											+ str.list2[y].backurl);
							imgs.css({
										width : "60px",
										height : "60px"
							...
							imgs.click(function(){
							huanhu($(this).attr("src"));
							});
							alert(str.list2[y].backurl);
							$('#messgecon').append(imgs);*/
						var s="";
						for (var y = 0; y < str.list2.length; y++) {
							s+="<img width='60' height='60' onclick='huanhu(this.src)' src='/OA/user_testpic?backurls="+str.list2[y].backurl+"'/>";
						}
				$('#messgecon')
						.html("<form id='imgform'><div id='imgbackfile'><input onchange='backgroundupdate()' type='file' name='backphoto' id='backid'/></div><img width='60' onclick='huanhu(this.src)' height='60' src='/OA/img/81.jpg'><img width='60' onclick='huanhu(this.src)' height='60' src='/OA/img/535eb53d44c6361e075d23e9c6358c9d.jpg'><img width='60' onclick='huanhu(this.src)' height='60' src='/OA/img/d.jpg'><img width='60' onclick='huanhu(this.src)' height='60' src='/OA/img/171334rfbtttctjlbsjhtj.jpg'>"+s+"</form>");
					}
				});
			});
